...
const query = groq`*[_type == "properties" && references(*[_type == "developer" && title == "Azizi Developments"]._id)] | order(_createdAt desc) {
  _id,
  title,
  slug,
