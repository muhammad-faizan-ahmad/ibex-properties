...
const query = groq`*[_type == "properties" && references(*[_type == "developer" && title == "Sobha Realty"]._id)] | order(_createdAt desc) {
  _id,
  title,
  slug,
