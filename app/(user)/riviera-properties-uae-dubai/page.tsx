...
const query = groq`*[_type == "properties" && references(*[_type == "developer" && title == "Riviera Properties"]._id)] | order(_createdAt desc) {
  _id,
  title,
  slug,
...
export default async function RivieraProperties() {
